...
!function (t) {
    ...
    return t.component("slider", {
        defaults: {
            ...
            this.container = this.element.find(".uk-slider"), this.focus = 0, t.$win.on("resize load", t.Utils.debounce(function () {
                ...
                "touchstart mousedown": function (r) {
                    r.originalEvent && r.originalEvent.touches && (r = r.originalEvent.touches[0]), r.button && 2 == r.button || !o.active || (o.stop(), s = t.$(r.target).is("a") ? t.$(r.target) : t.$(r.target).parents("a:first"), n = !1, s.length && s.one("click", function (t) {
                        n && t.preventDefault()
                    }), e = function (t) {
                        n = !0, i = o, a = {
                    ...
                    }, e.x = parseInt(r.pageX, 10), e.threshold = o.options.threshold)
                }, mouseenter: function () {
            ...
            return this.items = this.container.children().filter(":visible"), this.vp = this.element[0].getBoundingClientRect().width, this.container.css({
                ...
                e = t.$(this), a = e.css({
                    left: "",
                    width: ""
                })[0].getBoundingClientRect(), s = a.width, n = e.width(), h = Math.max(h, a.height), e.css({
                    left: r,
                    width: s
                }).data({idx: i, left: r, width: s, cwidth: n, area: r + s, center: r - (o.vp / 2 - n / 2)}), r += s
            }), this.container.css({
                "min-width": r,
                "min-height": h
            }), this.options.infinite && r <= 2 * this.vp && !this.itemsResized ? (this.container.children().each(function (t) {
            ...
            var e, s = this, n = this.items.eq(t), a = t, o = [], r = 0;
            if (1 == i) {
                for (e = 0; e < this.items.length && (a != t && (r += this.items.eq(a).data("width"), o.push(this.items.eq(a))), !(r > this.vp)); e++)a = a + 1 == this.items.length ? 0 : a + 1;
                ...
                for (e = this.items.length - 1; e > -1 && (r += this.items.eq(a).data("width"), a != t && o.push(this.items.eq(a)), !(r > this.vp)); e--)a = a - 1 == -1 ? this.items.length - 1 : a - 1;
                o.length && o.forEach(function (t) {
        ...
        if (t.originalEvent && t.originalEvent.touches && (t = t.originalEvent.touches[0]), e && Math.abs(t.pageX - e.x) > e.threshold && (window.getSelection().toString() ? i = e = !1 : e(t)), i) {
            var s, n, o, r, h, c, f, u, d, l;
            if (t.clientX || t.clientY ? s = t.clientX : (t.pageX || t.pageY) && (s = t.pageX - document.body.scrollLeft - document.documentElement.scrollLeft), h = a.focus, n = s - i.element.data("pointer-start").x, o = i.element.data("pointer-pos-start") + n, r = s > i.element.data("pointer-start").x ? -1 : 1, c = i.items.eq(a.focus), 1 == r)for (f = c.data("left") + Math.abs(n), u = 0, d = a.focus; u < i.items.length; u++) {
            ...
            i.options.infinite && h != a._focus && i.infinite(h, r), i.updatePos(o), a.dir = r, a._focus = h, a.touchx = parseInt(t.pageX, 10), a.diff = f
        }
