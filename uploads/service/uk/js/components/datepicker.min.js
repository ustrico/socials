...
!function (t) {
    ...
    return t.component("datepicker", {
        defaults: {
            ...
            this.current = s ? n(s, this.options.format) : n(), this.initdate = this.current.format("YYYY-MM-DD"), this.update(), "right" == t.langdirection && (r.right = window.innerWidth - (r.left + this.element.outerWidth()), r.left = "");
        ...
        function q(t) {
            ...
            for (a = A(t._f, t._locale).match(Ie) || [], e = 0; e < a.length; e++)s = a[e], n = (r.match(Z(s, t)) || [])[0], n && (i = r.substr(0, r.indexOf(n)), i.length > 0 && t._pf.unusedInput.push(i), r = r.slice(r.indexOf(n) + n.length), u += n.length), fn[s] ? (n ? t._pf.empty = !1 : t._pf.unusedTokens.push(s), j(s, n, t)) : t._strict && !n && t._pf.unusedTokens.push(s);
        ...
        De.normalizeUnits = function (t) {
            ...
            zone: function (t, e) {
                ...
                return null == t ? this._isUTC ? a : this._dateTzOffset() : ("string" == typeof t && (t = N(t)), Math.abs(t) < 16 && (t = 60 * t), !this._isUTC && e && (n = this._dateTzOffset()), this._offset = t, this._isUTC = !0, null != n && this.subtract(n, "m"), a !== t && (!e || this._changeInProgress ? g(this, De.duration(a - t, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, De.updateOffset(this, !0), this._changeInProgress = null)), this)
            },
            zoneAbbr: function () {
